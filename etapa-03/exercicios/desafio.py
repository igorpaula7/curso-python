...
def calcular_com_latas(tinta):
    ...
    print(f"Você precisa de {latas_necessarias} latas, que dará o valor de R$ {valor}.")
...
def calcular_com_galoes(tinta):
    ...
    print(f"Você precisa de {galoes_necessarios} galões, que dará o valor de R$ {valor}.")
...
def calcular_melhor_custo(tinta):
    ...
    # Calcular o número máximo de latas que faz sentido testar, ex: 17 = 1 + 2
    max_latas = math.ceil(tinta/ litros_lata) + 1
    
    for qtd_latas in range(max_latas + 1): # itera sobre o máximo de latas
        # Calcular quanta tinta ainda precisa cobrir com galões
        tinta_restante = tinta - (qtd_latas * litros_lata)
        ...
        # Calcular custo total desta combinação
        custo_total = qtd_latas * preco_lata + qtd_galoes * preco_galao
        
        # Verificar se é o menor custo até agora
        if custo_total < menor_custo:
            menor_custo = custo_total
            menos_latas = qtd_latas
            menos_galoes = qtd_galoes
    
    print(f"Você precisa de {menos_latas} latas e {menos_galoes} galões, com um custo total de R$ {menor_custo}.")
